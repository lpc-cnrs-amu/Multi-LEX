...
ui <- dashboardPage(
  ...
  dashboardSidebar(br(),
                   ...
                   radioButtons("rbrow", 
                                ...
                                choices = list("Frequent" = 50000,"1 million" = 1000000), 
                                selected = 50000,
                                width = "100%", 
                                inline = FALSE),
                   hr(), 
                   ...
                   tags$h4('Interface'),
                   br(),
                   tags$ul(tags$li(tags$b('File reading options, number of sequences'), ' : the initial loaded file is 50k rows long. Reading millions of sequences can take a few seconds.'), 
                           tags$li(tags$b('File reading options, columns'), ' : the initial display uses a 2-column table. Displaying "all" shows all the columns.'), 
  ...
  observe({
    ...
    output$dt <- DT::renderDataTable({ d }, filter="top", selection="multiple", escape=FALSE,
                                     ...
                                     options = list(dom = 'Bfrtip', 
                                                    ...
                                                    lengthMenu = list(c(50, 100, 500, 1000, 5000), c('50', '100', '500', '1000', '5000')), 
                                                    pageLength = 50,
